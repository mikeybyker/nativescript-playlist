...
export function setStatusBarColors() {
    ...
    function getStatusBarHeight() {
        var result = 0;
        var resourceId = application.android.currentContext.getResources().getIdentifier('status_bar_height', 'dimen', 'android');
        if (resourceId && resourceId > 0) {
            result = application.android.currentContext.getResources().getDimensionPixelSize(resourceId);
        }
        return result;
    }
*/
